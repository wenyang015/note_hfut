...
HD_PWD='D:/FPGA/verilog/sequence_detector/sequence_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sequence_detector_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sequence_detector_1.tcl
