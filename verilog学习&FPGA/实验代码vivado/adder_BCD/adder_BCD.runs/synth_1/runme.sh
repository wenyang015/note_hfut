...
HD_PWD='D:/FPGA/verilog/adder_BCD/adder_BCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_BCD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_BCD.tcl
