...
HD_PWD='D:/FPGA/verilog/Booth/Booth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Booth_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Booth_top.tcl -notrace
