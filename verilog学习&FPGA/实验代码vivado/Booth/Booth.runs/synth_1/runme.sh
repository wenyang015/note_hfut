...
HD_PWD='D:/FPGA/verilog/Booth/Booth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Booth_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Booth_top.tcl
