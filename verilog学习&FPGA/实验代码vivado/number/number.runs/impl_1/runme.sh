...
HD_PWD='D:/FPGA/verilog/number/number.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log number_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source number_top.tcl -notrace
