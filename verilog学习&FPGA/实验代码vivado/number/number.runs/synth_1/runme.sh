...
HD_PWD='D:/FPGA/verilog/number/number.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log number_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source number_top.tcl
